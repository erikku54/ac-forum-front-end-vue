   ...
   <main role="main">
     <div class="album py-5 bg-light">
       <div class="container">
          ...
          <user-profile-card :name="profile.name" :email="profile.email"
          :image="profile.image" :commentsNum="profile.Comments.length"
          :favoritedRestaurantNum="profile.FavoritedRestaurants.length"
          :followersNum="profile.Followers.length"
          :followingsNum="profile.Followings.length"
          :initialIsFollowed="isFollowed"
          @add-followed="addFollowed"
          @remove-followed="removeFollowed"
          ></user-profile-card>

          <div class="row">
            <div class="col-md-4">
              <user-followings-card :followings="profile.Followings"
              ></user-followings-card>
              <br>
              <user-followers-card :followers="profile.Followers"></user-followers-card>
            </div>

            <div class="col-md-8">
              <user-comments-card :comments="profile.Comments"></user-comments-card>
              <br>
              <user-favorited-restaurants-card :favoriteRestaurants="profile.FavoritedRestaurants"></user-favorited-restaurants-card>
            </div>
          </div>
       </div>
     </div>
